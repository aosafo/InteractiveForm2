$(document).ready(function () {
    ...
    // Append the spanTotalActivity to the activities section
    $(".activities").append(spanTotalActivity);

    // Append a <br> for the next line
    ...
    // Hide the paypal section when page is loaded
    $("#credit-card")[0].nextElementSibling.style.display = "none";

    // Hide the Bitcoin section when page is loaded
    $("#credit-card")[0].nextElementSibling.nextElementSibling.style.display = "none";

    // Add an change event for the payment  select dropdown
    $("#payment").on("change", function () {
        ...
        if ($(this).val() == "credit card") {
            ...
            // Show the paypal section
            $("#credit-card")[0].nextElementSibling.style.display = "block";
            ...
            $("#credit-card")[0].nextElementSibling.nextElementSibling.style.display = "block";
        }
    });
    ...
    function validateCreditCard() {
        ...
        if ($("#payment")[0].value == "credit card") {
            ...
            // Set the text of the errorCreditCardSpan to the Credit card entry has to be between 13 and 16 digits
            errorCreditCardSpan.text("The Credit card entry has to be between 13 and 16 digits");
            ...
            errorCVVSpan.text("The CVV nmust contain 3 digits");
